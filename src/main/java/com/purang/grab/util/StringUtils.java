...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static final String[] OUTPUT_EXCLUDES = { "createBy", "updateBy", "createDate", "updateDate", "page","sqlMap","currentUser" };
    ...
    public static String getRealNumberByUnit(String value,String unit){
    	String realNumber=value;
    	if(StringUtils.isNotEmpty(value)){
			double dvalue=Double.valueOf(value);
	    	switch(unit){
		    	case "%":
		    		realNumber=String.valueOf(dvalue/100);
		    		break;
		    	case "元":
		    		break;
		    	case "千元":
		    		realNumber=String.valueOf(dvalue*1000);
		    		break;
		    	case "万元":
		    		realNumber=String.valueOf(dvalue*10000);
		    		break;
		    	case "百万元":
		    		realNumber=String.valueOf(dvalue*1000000);
		    		break;
		    	case "千万元":
		    		realNumber=String.valueOf(dvalue*10000000);
		    		break;
		    	case "亿元":
		    		realNumber=String.valueOf(dvalue*100000000);
		    		break;
	    	}
    	}
    	return realNumber;
